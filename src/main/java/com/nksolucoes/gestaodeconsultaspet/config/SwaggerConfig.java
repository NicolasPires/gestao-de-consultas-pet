package com.nksolucoes.gestaodeconsultaspet.config;
...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.select()
				.apis(RequestHandlerSelectors.basePackage("com.nksolucoes.gestaodeconsultaspet.resources"))
	...
	private ApiInfo apiInfo() {
		return new ApiInfo("API de consultas veterinarias.",
				"Esta API é utilizada no processo seletivo Hapvida", 
				"Versão 1.0", " ",
				new Contact("Nicolas Kirk de Oliveira Pires", "https://www.linkedin.com/in/nicolas-kirk-de-oliveira-pires-2a5442a8/", "nicolask.pires@gmail.com"),
